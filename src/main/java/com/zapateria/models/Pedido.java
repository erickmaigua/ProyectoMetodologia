...
<<<<<<< HEAD
    ...
    public Date getQuejaFecha() { 
        return quejaFecha != null ? new Date(quejaFecha.getTime()) : null; 
    }
    public void setQuejaFecha(Date quejaFecha) { 
        this.quejaFecha = quejaFecha != null ? new Date(quejaFecha.getTime()) : null; 
    }
    ...
    public Date getQuejaFechaRespuesta() { 
        return quejaFechaRespuesta != null ? new Date(quejaFechaRespuesta.getTime()) : null; 
    }
    public void setQuejaFechaRespuesta(Date quejaFechaRespuesta) { 
        this.quejaFechaRespuesta = quejaFechaRespuesta != null ? new Date(quejaFechaRespuesta.getTime()) : null; 
    }
...
<<<<<<< HEAD
    ...
    public void setFechaDespacho(Date fechaDespacho) { 
        this.fechaDespacho = fechaDespacho != null ? new Date(fechaDespacho.getTime()) : null; 
    }
